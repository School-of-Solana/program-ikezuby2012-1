...
pub fn process_deposit(ctx: Context<Deposit>, amount: u64) -> Result<()> {
    ...
    if reserve.total_deposits == 0 {
        reserve.total_deposits = amount;
        reserve.total_deposit_shares = amount;
    }

    let deposit_ratio = amount.checked_div(reserve.total_deposits).unwrap();
    let users_shares = reserve.total_deposit_shares.checked_mul(deposit_ratio).unwrap();
    ...
    reserve.total_deposits += amount;
    reserve.total_deposit_shares += users_shares;
