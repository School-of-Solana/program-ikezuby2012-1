...
pub fn process_withdraw(ctx: Context<Withdraw>, amount: u64) -> Result<()> {
    ...
    let deposited_value = user.deposited_sol;
    ...
    let shares_to_remove = (amount as f64 / reserve.total_deposits as f64) * reserve.total_deposit_shares as f64;
    ...
    reserve.total_deposit_shares -= shares_to_remove as u64;
